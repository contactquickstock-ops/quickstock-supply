        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[82vh] flex flex-col">
            ...
            <div className="overflow-y-auto flex-1 px-6 py-5 space-y-4 text-sm text-gray-600 leading-relaxed"
              ...
              <p><strong className="text-gray-800">4. Orders &amp; Payments</strong><br />Orders are subject to availability and confirmation. We accept Cash on Delivery (COD) only. Prices are in Philippine Peso (₱) and may change without prior notice.</p>
              <p><strong className="text-gray-800">5. Delivery Policy</strong><br />Same-day delivery for orders before 3 PM. Free delivery on orders ₱500+. A ₱25 fee applies below ₱500.</p>
