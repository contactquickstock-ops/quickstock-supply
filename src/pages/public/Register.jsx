        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[82vh] flex flex-col">
            ...
            <div className="overflow-y-auto flex-1 px-6 py-5 space-y-4 text-sm text-gray-600 leading-relaxed"
              ...
              <p><strong className="text-gray-800">4. Orders &amp; Payments</strong><br />Orders are subject to availability and confirmation. We accept Cash on Delivery (COD) and GCash. GCash payments require a proof of payment upload for admin verification. Prices are in Philippine Peso (₱) and may change without prior notice.</p>
              <p><strong className="text-gray-800">5. Delivery Policy</strong><br />We offer same-day delivery, subject to availability. Free delivery on orders ₱500+. A ₱25 fee applies below ₱500.</p>
              ...
              <p><strong className="text-gray-800">7. Cancellation Policy</strong><br />Orders may only be cancelled before admin confirmation. Post-assignment cancellations are at admin discretion.</p>
              ...
              <p><strong className="text-gray-800">9. Limitation of Liability</strong><br />QuickStock Supply is not liable for indirect damages arising from service use, delays, or force majeure events.</p>
