        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[82vh] flex flex-col">
            ...
            <div className="overflow-y-auto flex-1 px-6 py-5 space-y-4 text-sm text-gray-600 leading-relaxed"
              ...
              <p><strong className="text-gray-800">5. Delivery Policy</strong><br />We offer same-day delivery within business hours (8:00 AM – 8:00 PM). Orders placed after 8:00 PM will be delivered the next business day. A ₱25 convenience fee applies to all non-member orders. Premium Members enjoy FREE delivery on orders ₱500 and above.</p>
              <p><strong className="text-gray-800">6. Cancellation Policy</strong><br />You may cancel an order while its status is Pending, Confirmed, or Assigned. Once the status changes to On the Way, cancellation is no longer allowed. To cancel, go to My Orders, open the order, and tap Cancel Order. A reason must be provided. Cancellations are immediate and cannot be reversed.</p>
              <p><strong className="text-gray-800">7. Premium Membership &amp; Rewards</strong><br />Only Premium Clients earn reward points. Membership requires ₱1,500 for 2 years (first-time) and ₱1,000/year for renewal. Terms may change with prior notice.</p>
              <p><strong className="text-gray-800">8. Prohibited Conduct</strong><br />You must not misuse the platform, submit false information, or engage in fraud. Violations may result in immediate account suspension.</p>
              <p><strong className="text-gray-800">9. Limitation of Liability</strong><br />QuickStock Supply is not liable for indirect damages arising from service use, delays, or force major events.</p>
